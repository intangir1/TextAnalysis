...
public class TempSynonimService extends Application {
    final String TAG = TempSynonimService.this.getClass().getSimpleName();

    private CallbacksForTemporalObjects callbacksForTemporalObjects;
    private ProgressDialog progMsg;
    private static TempSynonimService instance = null;
    private Activity activity;

    private TempSynonimService(){

    }


    public static TempSynonimService Get_instance(CallbacksForTemporalObjects _callbacksForTemporalObjects, Activity _activity){
        if(instance == null){
            instance = new TempSynonimService();
        }
    ...
    public void PostWord(FullText word){
        ...
        postManager.execute(DataStore.byTempSynonim, word.toJSON().toString());
    }
    ...
    public void PutWord(String word_to_replace, FullText word){
        ...
        putManager.execute(DataStore.byTempSynonim + word_to_replace, word.toJSON().toString());
    }
    ...
    public void InsertWord(String word_to_find, FullText word_to_add){
        ...
        putManager.execute(DataStore.byTempSynonim + "insert/" + word_to_find, word_to_add.toJSON().toString());
    }
}
