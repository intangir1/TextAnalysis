...
public class ExpressionService extends Application {
    final String TAG = ExpressionService.this.getClass().getSimpleName();
    ...
    public static ExpressionService Get_instance(CallbacksForNonRelationalWords _callbacksForNonRelationalWords, Activity _activity){
        if(instance == null){
    ...
    public void GetAllWords(){
        ApiGetManager apiGetManager = new ApiGetManager(new CallbacksWebApi() {
            ...
            public void onSuccess(String downloadedText, int httpStatusCode) {
                ...
                try{
                    ...
                    callbacksForNonRelationalWords.Return_array(result, 3);
                } catch (Exception e){
                    e.printStackTrace();
                }
            }
        ...
        apiGetManager.execute(DataStore.byExpressions);
    }
}
